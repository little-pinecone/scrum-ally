...
To see the API docs generated by Swagger build and run the application, and visit the [http://localhost:8080/swagger-ui/](http://localhost:8080/swagger-ui/) link in your browser.
